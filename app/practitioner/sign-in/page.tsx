...
export default function Page() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void; }) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch('https://medlink-server-production.up.railway.app/auth/practitioners', {
        method: 'POST',
        headers: {
          ...
          <form onSubmit={handleSubmit} className="mt-16">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-center text-zinc-900 text-sm font-normal leading-snug">
                ...
                <Link href="/practitioner/sign-up" className=" text-indigo-800 text-sm font-semibold underline leading-snug">
                  Create one
                </Link>
              </p>
            </div>
