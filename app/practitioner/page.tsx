  ...
  return (
    <main>
      <section className="section py-12 bg-slate-50">
        <p className=" text-black text-4xl font-semibold mb-4">Welcome Doctor</p>
        <p className="text-zinc-900 text-base font-normal leading-snug tracking-tight">This is where you manage appointments.</p>
      </section>
      {
        isLoading ? <Loading /> : (
          <section className="mt-10 grid  md:grid-cols-2 gap-10 section">
            <p className=" text-zinc-900 text-2xl font-semibold tracking-tight">Your Appointments</p>
