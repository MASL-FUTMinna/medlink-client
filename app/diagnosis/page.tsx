				...
				<MaxWidth>
					<div className=" bg-[#EDEBFFD1] rounded-r-3xl lg:rounded-r-[6rem] p-4 space-y-6 md:px-6 lg:px-12 md:py-16 lg:w-1/2 lg:space-y-10">
						...
						<p className=" text-gray-800 leading-6 md:text-lg lg:text-xl lg:leading-8">
							Take control of your well-being with our revolutionary AI diagnosis system. Guided by interactive
							clinical-history taking, our AI engages you in a personalized, insightful conversation to uncover
			...
			<MaxWidth>
				<section className=" py-12 md:py-16 lg:py-32 px-4">
					<div className=" grid gap-6 lg:grid-cols-2">
						<Image src={diagnosisImg1} alt="diagnosis" className=" object-cover mx-auto" />

						<div className=" space-y-2 lg:space-y-6">
							<h3 className=" text-2xl lg:text-3xl font-semibold">Welcome to MedLink AI Diagnosis</h3>

							<p className=" leading-6 text-gray-500  lg:text-lg lg:leading-8">
								Prepare for an interactive journey as we delve into your health history through a personalized
								clinical-history taking process. Your health story matters, and we're here to uncover the insights that
								matter most to you
							</p>
